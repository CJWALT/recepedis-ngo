    ...
    <>
        ...
        <Founder />
          ...
          <div className='pt-[3rem]'>
              <h3 className='text-[1.3rem] mb-2 leading-[25px] sm:text-[1.4rem] md:text-[1.8rem] xl:text-[2rem] font-medium text-center text-txtColor'>More Than 100 Thousand Donated since 2019</h3>
