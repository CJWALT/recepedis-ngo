...
function OurMission( ) {
  ...
  return (
        <section className='bg-[#EFEEEE] overflow-hidden h-[52rem] sm:h-[55rem] md:h-[38rem]'>
          <div className='w-[90%] sm:w-[80%] md:w-[90%] max-w-[1280px] mx-auto flex py-[3rem] md:flex-row flex-col gap-[2rem] md:gap-[1rem] lg:gap-[3rem] xl:gap-[5.3rem] max-x-[1280px]'>
            ...
            <div className='md:self-center md:h-[21rem] lg:h-[18rem] xl:h-[14rem] md:flex-grow md:basis-[55%]'>
              <div className=''>
              <h4 className='text-[#121A6B] font-semibold text-[1.3rem] sm:text-[1.5rem] mb-[.5rem]'>Our Mission</h4>
                ...
                <div className='mt-[.5rem] relative'>
                    <div className='border-[#ACACAC] relative flex flex-row gap-[1rem] sm:gap-[3rem] lg:gap-[3rem] xl:gap-[4rem] md:gap-[1.2rem] mb-[.8rem] border-b-4'>
                    ...
                    <div className={`${showTabs === 1 ? 'show-tabs' : 'hide-tabs'} tab-content font-regular text-[.7rem] sm:text-[1rem] sm:leading-[1.5rem] leading-[1rem]`}>
                    ...
                    <div className={`${showTabs === 2 ? 'show-tabs' : 'hide-tabs'} tab-content font-regular text-[.7rem] sm:text-[1rem] sm:leading-[1.5rem] leading-[1rem]`}>
                    ...
                    <div className={`${showTabs === 3 ? 'show-tabs' : 'hide-tabs'} tab-content font-regular text-[.7rem] sm:text-[1rem] sm:leading-[1.5rem] leading-[1rem]`}>
