...
function AboutSection() {
  return (
        <>
        <div className='pt-1 pb-4 md:pt-0 md:pb-0 md:py-[6rem] w-[90%] max-w-[1280px] flex flex-col md:flex-row gap-[.6rem] md:gap-[2.6rem] lg:gap-[4rem] xl:gap-[6rem] sm:w-[80%] md:w-[90%] mx-auto'>
            ...
            <div className='order-1 md:order-2 md:flex md:flex-col md:flex-auto'>
                <div className='h-[13rem] overflow-hidden justify-center mb-[.8rem] flex flex-col items-end'>
                    ...
                    <small className='text-[1rem] text-right block font-semibold w-[17rem] sm:w-[21rem]'>To Restore hope to a dying world giving life a meaning</small>
                </div>
