...
function ImgBackdrop({img, className}) {
  return (
    <>
      <div className={`relative mb-[3rem] flex justify-center before:w-[95%] before:h-[9.2rem] before:-left-[1.8rem] before:-bottom-[1.8rem] before:absolute before:rounded-[12px] w-[80%] mx-auto ${className}`}>
